...
# 1. Función para cargar los modelos y preprocesadores
# Usamos @st.cache_resource para que no se recarguen en cada iteración de la app
@st.cache_resource
def load_models():
    scaler = joblib.load('scaler.joblib')
    le_binarios = joblib.load('label_encoders_binarios.joblib')
    ohe_categoricas = joblib.load('one_hot_encoder_categoricas.joblib')
    modelo_nn = joblib.load('mejor_modelo_NN.joblib')
